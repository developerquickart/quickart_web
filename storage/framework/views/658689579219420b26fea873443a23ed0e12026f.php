                            ...
                            <div class="cart_tabbing_content" id="content">
                                <div id="1" class="tabcontent">
                                    <div class="content_Mainbox">
                                        ...
                                        <?php endif; ?>
                                        <?php if(isset($showCartProductList['status']) == 1): ?>
                                        <?php if(isset($showCartProductList['data'])): ?>
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <div class="cart_left_mainbox position__sticky1">
                                                    <div class="free_deliveryBox">
                                                        <img src="<?php echo e(asset('assets/images/freeDelivery.png')); ?>"
                                                    ...
                                                    <div class="car_product_list_mainBox">
                                                        <?php $__currentLoopData = $showCartProductList['data']['data']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index =>
                                                        $productCat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <!-- ---- -->
                                                        <div class="missed-items-slider calender_flex_class">
                                                            <div class="section-header">
                                                                <h5 class="heading-design-h5">
                                                                    <?php echo e($productCat['cat_name']); ?></span>
                                                                </h5>
                                                            </div>
                                                            <div class="sehedule_delivery_mainBox">
                                                                <div class="schedule_box1">
                                                                    <?php if($productCat['selectedDate'] != null): ?>
                                                                    <div class="other_category_box">
                                                                        <div class="other_category_content">
                                                                            <span>Your Other Category</span> will be
                                                                            delivered
                                                                            on
                                                                            <span><?php echo e(Carbon\Carbon::parse($productCat['selectedDate'])->isToday() ? 'Today' :
                                                                                                                                                (Carbon\Carbon::parse($productCat['selectedDate'])->isTomorrow() ? 'Tomorrow' :
                                                                                                                                                    Carbon\Carbon::parse($productCat['selectedDate'])->format('l'))); ?></span>
                                                                            between
                                                                            <span><?php echo e(str_replace(':00', '', $productCat['selectedTime'])); ?></span>
                                                                        </div>
                                                                        <div class="other_category_icon" id="modalBtn"
                                                                            data-productCat='<?php echo json_encode($productCat, 15, 512) ?>'
                                                                            onclick="openMyModal('1','modalBtn', this, <?php echo e($index); ?>)">
                                                                    ...
                                                                    <div class="schedule_box">
                                                                        <div class="schedule_header"
                                                                            ...
                                                                            <div class="day_box" id="dayBox">
                                                                                <?php echo e(Carbon\Carbon::parse($productCat['timeslotsdata'][0]['date'])->isToday() ? 'Today' :
                                                                            ...
                                                                            <div class="time_box" id="timeBox">
                                                                                <?php echo e(str_replace(':00', '', $productCat['timeslotsdata'][0]['timeslots'][0]['time_slots'])); ?>

                                                                            </div>
                                                                            <div id="arrowBox" class="arrow_box"
                                                                                data-productCat='<?php echo json_encode($productCat, 15, 512) ?>'
                                                                                onclick="openMyModal('1','arrowBox', this, <?php echo e($index); ?>)"
                                                                                title="Click Here">
                                                        ...
                                                        <?php if(!empty($cashbackMessage)): ?>
                                                            <div class="cashback_message"><?php echo e($cashbackMessage); ?></div>
                                                        <?php endif; ?>
                                                        <!-- --- -->
                                                        <?php $__currentLoopData = $productCat['products']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                ...
                                                                <div class="order_info">
                                                                    <div class="order-namingBox">
                                                                        <div class="item">
                                                                            ...
                                                                            <div class="weightBox">
                                                                                <span><?php echo e($product['quantity']); ?>
                                                                    ...
                                                                    <div class="order_details mt-2">
                                                                        <div class="row g-0">
                                                                            <div class="col-4">
                                                                                <?php if($product['product_feature_value'] != null || $product['product_feature_value'] != ""): ?>
                                                                                <div class="order_product_name1" style="font-weight: 500;">Your Packaging Preference</div>
                                                                                <div class="feature_txt">
                                                                                    <span><?php echo e($product['product_feature_value']); ?></span>
                                                                                    <span><img src="<?php echo e(asset('assets/images/remove01.png')); ?>" alt="close" class="img-fluid varient_close_btn" onclick='removeSelectedPreference("<?php echo e($product["varient_id"]); ?>", "daily")'></span>
                                                                                </div>
                                                                                <?php endif; ?>
                                                                            </div>
                                                                            <div class="col-8">
                                                                                <div class="sub_btn_mainBox">
                                                                                    <?php if($product['isOfferProduct'] == 'false'): ?>
                                                                                        <?php if($product['isSubscription'] == "false"): ?>
                                                                                            <?php if($product['availability'] == "all" || $product['availability'] == "subscription"): ?>
                                                                                            <div class="sub_box">
                                                                                                <a class="subscribe_btn"
                                                                                                    data-product='<?php echo json_encode($product, 15, 512) ?>'
                                                                                                    onclick="removeToSubCartCall('<?php echo e($product['varient_id']); ?>', 'add','<?php echo e($product['cart_qty']); ?>','','','','','','<?php echo e($product['product_name']); ?>','<?php echo e($product['price']); ?>', '<?php echo e($product['product_feature_id']); ?>')">
                                                                                                    SUBSCRIBE
                                                                                                    <?php echo e($product['percentage'] == 0 ? '' : ($product['percentage'] == null ? '' : '& SAVE ' . $product['percentage'] . '%')); ?>
                                                                                    ...
                                                                                    <div class="cart_button_Box">
                                                                                        ...
                                                                                        <div class="cart_btn" data-product-id="<?php echo e(trim($product['product_id'])); ?>" data-productdetail='<?php echo json_encode($product, 15, 512) ?>'>
                                                                                            <div class="qtyBox"
                                                                                                ...
                                                                                                <input type="text" name="qty"
                                                                                                    value="<?php echo e(trim($product['cart_qty'])); ?>" id="totalCartQTY"
                                                                                        ...
                                                                                        <div class="cart_deletebox">
                                                                                            <img src="<?php echo e(asset('assets/images/delete.svg')); ?>"
                                                                                                alt="Delete icon"
                                                                                                class="img-fluid"
                                                                                                onclick="removeDailyCartProduct(<?php echo e($product['varient_id']); ?>, '0', '<?php echo e($product['product_name']); ?>', <?php echo e($product['price']); ?>)">
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                    ...
                                                    <?php if(isset($showCartProductList['data']['offer_product'])  &&
                                                    ...
                                                    <div class="cart_offers_mainBox position-relative">
                                                        <div class="cart_offer_buy_textBox">
                                                            <div class="cart_offer_img">
                                                                <img src="<?php echo e(asset('assets/images/cart-gift.png')); ?>" alt="gift" class="img-fluid">
                                                            </div>
                                                            <div class="cart_offer_textBox">Buy for AED <?php echo e($showCartProductList['data']['oneday_min_order_amount']); ?> & get this product for just 1 AED</div>
                                                        </div>
                                                         <?php $__currentLoopData = $showCartProductList['data']['offer_product']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <div class="cart_offer_product_mainBox">
                                                            <div class="cart_product_list">
                                                                <div class="ordered_product">
                                                                    <div class="product_imgbox">
                                                                        <a href="<?php echo e(url('product-details?name='.Str::slug($product['product_name']).'&id='.$product['product_id'])); ?>">
                                                                            <img src="<?php echo e($product['product_image']); ?>" alt="Fresh Cow Ghee" class=" img-fluid">
                                                                        </a>
                                                                    </div>
                                                                    <div class="order_info">
                                                                        <div class="order-namingBox">
                                                                            <div class="itemBox">
                                                                                ...
                                                                                <div class="weightBox my-2">
                                                                                    <span><?php echo e($product['quantity']); ?> <?php echo e($product['unit']); ?></span>
                                                                                </div>
                                                                                <div class="priceBox">
                                                                            ...
                                                                            <?php if($showCartProductList['data']['total_price'] >= $showCartProductList['data']['oneday_min_order_amount'] && $product['is_added'] == false ): ?>
                                                                            <div class="itemBox">
                                                                                <div class="blue_button"
                                                                                    onclick='removeDailyCartProduct(<?php echo e(json_encode($product["varient_id"])); ?>, "1", <?php echo e(json_encode($product["product_name"])); ?>, <?php echo e(json_encode($product["price"])); ?>)'>
                                                                                    Add
                                                                                </div>
                                                                            </div>
                                                                            <?php endif; ?>
                                                            ...
                                                            <div class="unlocked_product_box">
                                                                <div class="cart_offer_buy_textBox">
                                                                    <div class="cart_offer_img">
                                                                        <img src="<?php echo e(asset('assets/images/lock.png')); ?>" alt="gift" class="img-fluid">
                                                                    </div>
                                                                     <?php if($showCartProductList['data']['total_price'] < $showCartProductList['data']['oneday_min_order_amount']): ?>
                                                                        <div class="cart_offer_textBox">
                                                                            Just <strong>AED <?php echo e(number_format(abs($showCartProductList['data']['oneday_min_order_amount'] - $showCartProductList['data']['total_price']), 2)); ?></strong> away from unlocking this product!
                                                                        </div>  
                                                                    <?php else: ?>
                                                        ...
                                                        <div class="offers_bomb" id="offerPopup" style="display:none;">
                                                            <img src="<?php echo e(asset('assets/images/offer_animation.gif')); ?>" alt="offers_bomb" class="img-fluid">
                                                        </div>
                                            ...
                                            <div class="col-lg-6">
                                                <div class="car_order_detailsBox ">
                                                    ...
                                                    <div class="order_detailbox">
                                                            ...
                                                            <table>
                                                                <tbody>
                                                                    <tr>
                                                                        <td>Item Total :</td>
                                                                        <td><span>
                                                                                <?php if($showCartProductList['data']['total_price']!=$showCartProductList['data']['total_mrp']): ?>
                                                                                <span class="regular-price">AED
                                                                                    <span>
                                                                                        <?php echo e(number_format($showCartProductList['data']['total_mrp'], 2)); ?></span></span>
                                                                                <!-- </p> -->
                                                                                <?php endif; ?>
                                                                            </span> AED
                                                                            <?php echo e(number_format($showCartProductList['data']['total_price'], 2)); ?>
                                                                    ...
                                                                    <tr class="small-text">
                                                                        ...
                                                                        <td>AED
                                                                            <?php echo e(number_format($showCartProductList['data']['delivery_charge'], 2)); ?>
                                                                    ...
                                                                    <tr class="small-text">
                                                                        <td>VAT</td>
                                                                        <td>AED
                                                                            <?php echo e(number_format($showCartProductList['data']['vat'], 2)); ?>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td id=totalValue><strong>AED
                                                                                <?php echo e(number_format($showCartProductList['data']['total_price'], 2)); ?></strong>
                                                                        </td>
                                                                    </tr>
                                                                        ...
                                                                        <td>
                                                                            <span
                                                                                ...
                                                                                <label for="daily_wallet">AED
                                                                                    <span
                                                                                        id="walletAmountD"><?php echo e(number_format($showCartProductList['data']['wallet_balance'], 2)); ?></span>
                                                                                </label>
                                                                                <input type="checkbox"
                                                                                ...
                                                                                <input type='hidden'
                                                                                    ...
                                                                                    value="<?php echo e($showCartProductList['data']['wallet_deduction_percentage']); ?>">
                                                                            </span>
                                                                            <br>
                                                                            <span id="walletTextD"
                                                                    ...
                                                                    <tr>
                                                                        <td>Total to Pay</td>
                                                                        <td id="toPay"><strong>AED <?php echo e(number_format($showCartProductList['data']['total_price'], 2)); ?></strong></td>
                                                                    </tr>
                                                        ...
                                                        <?php if(!empty($totalCashbackMessage)): ?>
                                                            <div class="cashback_message"><?php echo e($totalCashbackMessage); ?></div>
                                                        <?php endif; ?>
                                                    ...
                                                    <div class="order_detailbox">
                                                        <div class="payment_address_box p-0 m-0">
                                                            <?php //echo "<pre>";print_r($showCartProductList['data']);echo "</pre>"; ?>
                                                                ...
                                                                <div class="address_details">
                                                                    <div class="address_head">
                                                                        ...
                                                                        <span class="address-type" id="addressType"
                                                                            ...
                                                                            <?php echo e($showCartProductList['data']['lastadd'][0]['type'] ?? ''); ?>

                                                                        </span>
                                                                    </div>
                                                                    <div class="address_location" id="showAddress">
                                                                        <p class="loaction">
                                                                            <?php echo e($showCartProductList['data']['lastadd'][0]['house_no'] ?? ''); ?>

                                                                        </p>
                                                                    </div>
                                                                    <input type="hidden" id="addressId"
                                                                        name="address_id"
                                                                        value="<?php echo e($showCartProductList['data']['lastadd'][0]['address_id'] ?? ''); ?>">
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div class="payment_mainBox new_payment_mainBox">
                                                            ...
                                                            <div id="COD" class="content-div">
                                                                <div class="cod_icon_test_mainbox">
                                                                    ...
                                                                    <div class="cod_content_box">
                                                                        ...
                                                                        <?php echo e(number_format($showCartProductList['data']['codcharges'], 2)); ?>
                                                                ...
                                                                <div class="pay_btnbox">
                                                                    <div class="pay_btn_listing"
                                                                        ...
                                                                        <div class="pay_btn_icon">
                                                                            <img src="<?php echo e(asset('assets/images/money.svg')); ?>"
                                                                    ...
                                                                    <div class id='payNow'>
                                                                        <div
                                                                            ...
                                                                            <?php if(!empty($showCartProductList['data']['lastcarddetails'])): ?>
                                                                                ...
                                                                                <div class="card_details">
                                                                                    <div class="acard_details">
                                                                                        Pay with card <span class="card-type"
                                                                                            ...
                                                                                            <?php echo e($showCartProductList['data']['lastcarddetails']['card_no'] ?? ''); ?></span>
                                                                                    </div>
                                                                                    <input type="hidden" id="siNo" name="si_no"
                                                                                        value="<?php echo e($showCartProductList['data']['lastcarddetails']['si_sub_ref_no'] ?? ''); ?>">
                                                                                </div>
                                                                            </div>
                                                                            <?php endif; ?>
                                                                            <div class="change_btn"
                                                                                ...
                                                                                onclick="fetchCardList('<?php echo e($showCartProductList['data']['lastcarddetails']['si_sub_ref_no'] ?? ''); ?>')">
                                                                                <?php if(!empty($showCartProductList['data']['lastcarddetails'])): ?>
                                                                                    Change
                                                                                <?php else: ?>
                                                                                    Add Card
                                                        ...
                                                        <div class="pay_btn_wrap new_pay_btn_wrap">
                                                            ...
                                                            <input type="hidden" name="total_price" id="total_price" value="<?php echo e($showCartProductList['data']['total_price']); ?>">
                                                            <input type="hidden" name="cod_extra_charges" id="cod_extra_charges" >
                                                            <input type="hidden" name="cod_charges" id="cod_charges" value="<?php echo e($showCartProductList['data']['codcharges']); ?>">
                                        ...
                                        <div class="missed_product_list section-padding">
                                            ...
                                            <?php if(isset($mightHaveMissedProductList['data'])): ?>
                                            <div class="owl-carousel owl-carousel-featured">
                                                <?php $__currentLoopData = $mightHaveMissedProductList['data']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <?php if(!$product['stock'] == 0): ?>
                                                <div class="item">
                                                    <div class="product">
                                                        <div class="product_header">
                                                            <div class="product_top_left">
                                                                <?php if($product['percentage'] > 0): ?>
                                                                <div class="discount_text">
                                                                    <?php echo e(number_format($product['percentage'], 0)); ?>%<span>Off</span>
                                                                </div>
                                                                <?php endif; ?>
                                                            </div>
                                                        ...
                                                        <a href="<?php echo e(url('product-details')); ?>/<?php echo e(Str::slug($product['product_name'])); ?>/<?php echo e(trim($product['product_id'])); ?>">
                                                            <div class="product-img">
                                                                <img class="img-fluid"
                                                                    src="<?php echo e($product['varient_image']); ?>" alt="product">
                                                            </div>
                                                            <?php if(isset($product['feature_tags']) &&
                                                            ...
                                                            <div class="product_featured_cat_icon_list">
                                                                <div class="product_featured_cat_icon">
                                                                    ...
                                                                    <img class="img-fluid"
                                                                        src="<?php echo e(trim($tags['image'])); ?>" alt="Product">
                                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                                </div>
                                                            </div>
                                                            <?php endif; ?>
                                                            <div class="product-body">
                                                                <div class="product_name"><?php echo e($product['product_name']); ?>
                                                        ...
                                                        <div class="product_weight" style="display: flex; align-items: center; gap: 8px;">
                                                            ...
                                                            <div class="change-qty" data-productDetail='<?php echo json_encode($product, 15, 512) ?>' data-screen-name='cart'>
                                                    ...
                                                    <div class="product">
                                                        <div class="product_header">
                                                            <div class="product_top_left">
                                                                ...
                                                                <?php endif; ?>
                                                                <?php if(!empty($product['country_icon'])): ?>
                                                        ...
                                                        <div class="product-body notify_box">
                                                            <div class="product-body">
                                                                <div class="product_name">
                                                                    <?php echo e(trim($product['product_name'])); ?></div>
                                ...
                                <?php if(isset($subCartProductList['status']) == 1): ?>    
                                <?php if(isset($subCartProductList['data'])): ?>
                                <div class="content_Mainbox">
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <div class="cart_left_mainbox position__sticky1">
                                                    <div class="free_deliveryBox">
                                                        <img src="<?php echo e(asset('assets/images/freeDelivery.png')); ?>"
                                                            alt="lock" style="max-width:30px">
                                                        <span><strong>FREE Delivery</strong> - Shop now & Save!</span>
                                                    </div>
                                                    <div class="car_product_list_mainBox">
                                                        <?php $__currentLoopData = $subCartProductList['data']['data']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <div class="car_product_list">
                                                            <div class="ordered_product">
                                                                <div class="product_imgbox">
                                                                     <a href="<?php echo e(url('product-details')); ?>/<?php echo e(Str::slug($product['product_name'])); ?>/<?php echo e(trim($product['product_id'])); ?>">
                                                                ...
                                                                <div style="width:100%;">
                                                                    <div style="width:100%;">
                                                                        <div class="order_info" style="width:100%;">
                                                                            <div class="order-namingBox">
                                                                                ...
                                                                                <div class="item">
                                                                                    <div class="priceBox text-end">
                                                                                        <div class="actual_price">AED
                                                                                            <span><?php echo e(number_format($product['subscription_price'], 2)); ?></span>
                                                                                        </div>
                                                                                        <div class="mrp_price">
                                                                                            <?php if($product['subscription_price'] !=
                                                                                            $product['mrp']): ?>
                                                                                            <span
                                                                                                class="regular-price">AED
                                                                                                <span><?php echo e(number_format($product['mrp'], 2)); ?></span>
                                                                                            </span>
                                                                                            <?php endif; ?>
                                                                                        </div>
                                                                                    </div>
                                                                        ...
                                                                        <div class="order_details mt-2">
                                                                            <div class="row g-0">
                                                                                <div class="col-6">
                                                                                    <?php if($product['product_feature_value'] != null || $product['product_feature_value'] != ""): ?>
                                                                                    <div class="order_product_name1" style="font-weight: 400;">Your Packaging Preference</div>
                                                                                    <div class="feature_txt">
                                                                                        <span><?php echo e($product['product_feature_value']); ?></span>
                                                                                        <span><img src="<?php echo e(asset('assets/images/remove01.png')); ?>" alt="close" class="img-fluid varient_close_btn" onclick='removeSelectedPreference("<?php echo e($product["varient_id"]); ?>", "subscription")'></span>
                                                                                    </div>
                                                                                    <?php endif; ?>
                                                                                </div>
                                                                                <div class="col-6">
                                                                                    <div class="sub_btn_mainBox">
                                                                                        <div class="">
                                                                                            <div class="cart_btn2">
                                                                                                <div class="qtyBox"
                                                                                                    data-product='<?php echo json_encode($product, 15, 512) ?>'>
                                                                                                     <button  class="qty-btn qty-btn-minus" onclick="removeToSubCartCall('<?php echo e($product['varient_id']); ?>', 'minus', '<?php echo e($product['cart_qty']); ?>', '<?php echo e($product['sub_time_slot']); ?>', '<?php echo e($product['sub_total_delivery']); ?>', '<?php echo e($product['sub_delivery_date']); ?>', '<?php echo e($product['repeat_orders']); ?>', '<?php echo e($product['isautorenew']); ?>','<?php echo e($product['product_name']); ?>','<?php echo e($product['price']); ?>', '<?php echo e($product['product_feature_id']); ?>')">-</button>
                                                                                                     <input type="text"
                                                                                                        name="qty"
                                                                                                        value="<?php echo e($product['cart_qty']); ?>"
                                                                                                        class="input-qty input-rounded"
                                                                                                        min="1">
                                                                                                     <button class="qty-btn qty-btn-plus" onclick="removeToSubCartCall('<?php echo e($product['varient_id']); ?>', 'plus', '<?php echo e($product['cart_qty']); ?>', '<?php echo e($product['sub_time_slot']); ?>', '<?php echo e($product['sub_total_delivery']); ?>', '<?php echo e($product['sub_delivery_date']); ?>', '<?php echo e($product['repeat_orders']); ?>', '<?php echo e($product['isautorenew']); ?>','<?php echo e($product['product_name']); ?>','<?php echo e($product['price']); ?>', '<?php echo e($product['product_feature_id']); ?>')">+</button>
                                                                                                </div>
                                                                                            </div>
                                                                                        </div>
                                                                                        <div class="cart_deletebox"
                                                                                                onclick="removeToSubCartCall('<?php echo e($product['varient_id']); ?>', 'remove','','','','','','','<?php echo e($product['product_name']); ?>','<?php echo e($product['price']); ?>', '<?php echo e($product['product_feature_id']); ?>')">                                                                                            
                                                                                                <img src="<?php echo e(asset('assets/images/delete.svg')); ?>"
                                                                                                alt="Delete icon"
                                                                                                class="img-fluid">
                                                                                        </div>
                                                                    ...
                                                                    <!--  -->
                                                                    <?php if($product['repeat_orders'] == ""): ?>
                                                                    <div class="required_info_text cursor_pointer"
                                                                        data-product='<?php echo json_encode($product, 15, 512) ?>'
                                                                        onclick="showWeekListUI('cart', this)">
                                                                        Please <strong>click here</strong> to select all
                                                                        required
                                                                        information.
                                                                    </div>
                                                                    <?php else: ?>
                                                                    ...
                                                                    <!--  -->
                                                                    <?php
                                                                        $subDeliveryDate = $product['sub_delivery_date'] ?? null;
                                                                        $subTimeSlot = $product['sub_time_slot'] ?? null;
                                                                        $isPastDate = false;
                                                                    
                                                                        if ($subDeliveryDate && $subTimeSlot) {
                                                                            // Today's date (without time)
                                                                            $todayDate = new DateTime();
                                                                            $todayDateOnly = new DateTime($todayDate->format('Y-m-d'));
                                                                    
                                                                            // Convert delivery date (without time)
                                                                            try {
                                                                                $deliveryDateOnly = new DateTime((new DateTime($subDeliveryDate))->format('Y-m-d'));
                                                                    
                                                                                // Check if delivery date is before or equal to today
                                                                                $isPastDate = $deliveryDateOnly <= $todayDateOnly;
                                                                            } catch (Exception $e) {
                                                                                $isPastDate = false; // fallback if date is invalid
                                                                            }
                                                                        }
                                                                    ?>
                                                                    ...
                                                                    <div class="required_info_text cursor_pointer"
                                                                        ...
                                                                        <div class="" style="color: black;">
                                                                            Repeats on <strong
                                                                                style="color:green;"><?php echo e($product['repeat_orders']); ?></strong>
                                                                            for <strong
                                                                                style="color: green;"><?php echo e($product['sub_total_delivery']); ?></strong>
                                                                            weeks from <strong
                                                                                style="color:green;"><?php echo e($product['sub_time_slot']); ?></strong>
                                                                        </div>
                                                                    </div>
    
                                                                    <div class="pass-date cursor_pointer"
                                                                        data-product='<?php echo json_encode($product, 15, 512) ?>'
                                                                        onclick="showWeekListUI('cart', this)"
                                                                        style="color: #c71e25">
                                                                        The subscription date you selected is in the
                                                                        past.
                                                                        Please choose another date.
                                                                    </div>
                                                                    <?php else: ?>
                                                                    <div class="required_info_text cursor_pointer"
                                                                        data-product='<?php echo json_encode($product, 15, 512) ?>' style="color: black;"
                                                                        onclick="showWeekListUI('cart', this)">
                                                                        Repeats on <strong
                                                                            style="color:green;"><?php echo e($product['repeat_orders']); ?></strong>
                                                                        for <strong
                                                                    ...
                                                                    <?php endif; ?>
                                                                <!--  -->
                                                                <div class="check-date" id="checkDate">
                                                                    <div class="required_info_text"
                                                                        data-product-date="<?php echo e($product['sub_delivery_date']); ?>"
                                                                        data-product-datetime="<?php echo e($product['sub_time_slot']); ?>">
                                                                        <div class="required_info_text cursor_pointer"
                                                                            data-product='<?php echo json_encode($product, 15, 512) ?>'
                                                                            onclick="showWeekListUI('cart', this)">
                                                                        </div>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="car_order_detailsBox position__sticky1">
                                                <div class="order_detailbox">
                                                    <div class="order-subheading d-flex align-items-center">
                                                        Order Summary
                                                    </div>
                                                        ...
                                                        <table>
                                                            <tbody>
                                                                <tr>
                                                                    ...
                                                                    <td id="totalPrice">
                                                                        <span>
                                                                            <?php if($subCartProductList['data']['total_price']!=
                                                                            $subCartProductList['data']['total_mrp']): ?>
                                                                            <span class="regular-price">AED
                                                                                <span><?php echo e(number_format($subCartProductList['data']['total_mrp'], 2)); ?></span>
                                                                            </span>
                                                                            <?php endif; ?>
                                                                        </span> AED
                                                                        <?php echo e(number_format($subCartProductList['data']['total_price'], 2)); ?>
                                                                ...
                                                                <tr class="small-text">
                                                                    <td>Delivery Charges</td>
                                                                    <td>AED
                                                                        <?php echo e(number_format($subCartProductList['data']['delivery_charge'], 2)); ?>
                                                                ...
                                                                <tr class="small-text">
                                                                    <td>VAT</td>
                                                                    <td>AED
                                                                        <?php echo e(number_format($subCartProductList['data']['vat'], 2)); ?>
                                                                    ...
                                                                    <td>
                                                                        <span
                                                                            ...
                                                                            <label for="subscription_wallet">AED
                                                                                <span
                                                                                    id="walletAmountS"><?php echo e(number_format($subCartProductList['data']['wallet_balance'], 2)); ?></span>
                                                                            </label>
                                                                            <input type="checkbox"
                                                                                onclick="onWalletSelected(this)"
                                                                                name="subscription_wallet"
                                                                                id="subscription_wallet">
                                                                            <input type='hidden' id='walletPercentage'
                                                                                name='wallet-percentage'
                                                                                value="<?php echo e($subCartProductList['data']['wallet_deduction_percentage']); ?>">
                                                                        </span>
                                                                        <br>
                                                                        <span id="walletText"
                                                                            style="color: green; display: none;">
                                                                            <span id="selectedWalletAmount"></span>
                                                                            <label id="appliedWallet"
                                                                                style="color: black; display: inline;">
                                                                                AED Wallet applied
                                                                            </label>
                                                                        </span>
                                                                ...
                                                                <tr>
                                                                    <td>Total to Pay</td>
                                                                    <td>
                                                                        <strong id="totalPay">AED
                                                                            <?php echo e(number_format($subCartProductList['data']['total_price'], 2)); ?></strong>
                                                                    </td>
                                                                </tr>
                                                ...
                                                <div class="order_detailbox">
                                                       <div class="payment_address_box p-0 m-0">
                                                            <?php //echo "<pre>";print_r($subCartProductList['data']);echo "</pre>"; ?>
                                                            ...
                                                            <div class="address_detailsBox change_addressbox">
                                                                ...
                                                                <div class="address_details">
                                                                    <div class="address_head">
                                                                        ...
                                                                        <span class="address-type" id="addressType"
                                                                            style="font-weight: 600;">
                                                                            <?php echo e($subCartProductList['data']['lastadd'][0]['type'] ?? ''); ?>

                                                                        </span>
                                                                    </div>
                                                                    <div class="address_location" id="showAddress">
                                                                        <p class="loaction">
                                                                            <?php echo e($subCartProductList['data']['lastadd'][0]['house_no'] ?? ''); ?>

                                                                        </p>
                                                                    </div>
                                                                    <input type="hidden" id="addressId"
                                                                        name="address_id"
                                                                        value="<?php echo e($subCartProductList['data']['lastadd'][0]['address_id'] ?? ''); ?>">
                                                                </div>
                                                            </div>
                                                            <div class="change_btn btn_addresslist"
                                                                style="font-weight: 600; color: green;"
                                                ...
                                                <div class="payment_mainBox new_payment_mainBox">
                                                    <div class="trial_radio_btn_box">
                                                        <div class="trial_radio_mainbox">
                                                            <div class="trial_radio_btn">
                                                                ...
                                                                <input type="radio" id="payNow" name="toggle-two"
                                                                    value="Pay Now" onclick="toggleSubRadioBtnCharges()"
                                                                    checked>
                                                            </div>
                                                            <div class="trial_radio_btn">
                                                                <label for="payPerDelivery">Pay Per Delivery</label>
                                                                <input type="radio" id="payPerDelivery"
                                                                    name="toggle-two" value="Pay Per Delivery"
                                                                    onclick="toggleSubRadioBtnCharges()">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    
                                                    <?php if(($subCartProductList['data']['isAutoRenew'] ?? '') === 'no'): ?>
                                                    <div class="show-pay-btn" >
                                                        <div class="pay_btnbox subscription_cart_btn">
                                                            <div class="pay_btnbox1 gap-2" id="quickPay">
                                                                <div  class="pay_btn_listing"
                                                                    onclick="checkOutSubCartPaymentApiCall('quickPay')">
                                                                    <div class="pay_btn_icon">
                                                                        <img src="<?php echo e(asset('assets/images/money.svg')); ?>"
                                                                            alt="Pay Icon" class="img-fluid">
                                                                    </div>
                                                                ...
                                                                <div id="applyBtn" style="opacity:0;">
                                                                    <div class="pay_btn_listing" onclick="checkOutSubCartPaymentApiCall('applepay')">
                                                                        <div class="pay_btn_icon">
                                                                            <img src="<?php echo e(asset('assets/images/apple.svg')); ?>"
                                                                                alt="Pay Icon" class="img-fluid">
                                                                        </div>
                                                            ...
                                                            <div class="show-card" id="cardNoSe">
                                                                <div class="payment_address_box payment_address_box_without_border">
                                                                 <?php if(!empty($subCartProductList['data']['lastcarddetails'])): ?>
                                                                    <div class="address_detailsBox">
                                                                        <div class="payment_add_img">
                                                                            <img src="<?php echo e(asset('assets/images/pay_card.png')); ?>"
                                                                                alt="lock" style="max-width:35px">
                                                                        ...
                                                                        <div class="card_details">
                                                                            <div class="acard_details">
                                                                                Pay with card <span class="card-type"
                                                                                    id="cardType" style="font-weight: 600;">
                                                                                    <?php echo e($subCartProductList['data']['lastcarddetails']['card_no'] ?? ''); ?></span>
                                                                            </div>
                                                                            <input type="hidden" id="siNo" name="si_no"
                                                                                value="<?php echo e($subCartProductList['data']['lastcarddetails']['si_sub_ref_no'] ?? ''); ?>">
                                                                        </div>
                                                                    </div>
                                                                 <?php endif; ?>
                                                                    <div class="change_btn"
                                                                        style="font-weight: 600; color: green;"
                                                                        data-bs-toggle="modal" data-bs-target="#cardModal"
                                                                        onclick="fetchCardList('<?php echo e($subCartProductList['data']['lastcarddetails']['si_sub_ref_no'] ?? ''); ?>')">
                                                                        <?php if(!empty($subCartProductList['data']['lastcarddetails'])): ?>
                                                                            Change
                                                                        <?php else: ?>
                                                                            Add Card
                                                    ...
                                                    <?php else: ?>
                                                        ...
                                                        <div class="autorenewcheck">
                                                        Your auto-renwal is now active. You can place orders only by using your saved cards.
                                                        </div>
                                                        <?php endif; ?>
                                                    <input type="hidden" name="auto-renew" id="autoRenewID" value="<?php echo e($subCartProductList['data']['isAutoRenew']); ?>">    
                                                    <div class="pay_btn_wrap new_pay_btn_wrap">
                                                        <div class="trial_total_box">
                                                            <span class="total_heading">Total</span>
                                                            <span class="total_amount"><strong id="totalAmt">AED
                                                                    <?php echo e(number_format($subCartProductList['data']['total_price'], 2)); ?></strong>
                                                            </span>
                                                        </div>
                                                        <div class="pay_btn" onclick="checkOutSubCartApiCall()">
                                                            <span>Place Order</span>
                                                        </div>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="owl-carousel owl-carousel-featured">
                                        ...
                                        <div class="item">
                                            <div class="product">
                                                ...
                                                <a href="<?php echo e(url('product-details')); ?>/<?php echo e(Str::slug($product['product_name'])); ?>/<?php echo e(trim($product['product_id'])); ?>">
                                                    <div class="product-img">
                                                        <img class="img-fluid" src="<?php echo e($product['varient_image']); ?>"
                                                            alt="product">
                                                    </div>
                                                    <?php if(isset($product['feature_tags']) &&
                                                    count($product['feature_tags']) > 0): ?>
                                                    <div class="product_featured_cat_icon_list">
                                                        <div class="product_featured_cat_icon">
                                                            <?php $__currentLoopData = $product['feature_tags']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tags): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <img class="img-fluid" src="<?php echo e(trim($tags['image'])); ?>"
                                                                alt="Product">
                                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="product-footer">
                                                    ...
                                                    <div class="cart_btn">
                                                        <div class="sub_box">
                                                            <a class="subscribe_btn"
                                                                data-product='<?php echo json_encode($product, 15, 512) ?>'
                                                                onclick="removeToSubCartCall('<?php echo e($product['varient_id']); ?>', 'add','<?php echo e($product['cart_qty']); ?>','','','','','','<?php echo e($product['product_name']); ?>','<?php echo e($product['price']); ?>', '0')">
                                                                Add
                                                            </a>
                                                        </div>
                                                    </div>
                ...
                <div class="modal-header">
                    <div class="col-lg-12">
                        <div class="section-header">
                            ...
                            <a class="add_card_btn" href="<?php echo e(url('add-address?addedFrom=cart&tab='.\Request::get('tab'))); ?>">
                                Add New address</a>
                        </div>
                    </div>
...
<script>
        document.addEventListener("DOMContentLoaded", function () {
             const minOrderAmount = <?php echo e($minOrderAmount ?? ''); ?>;
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    var savedTab = "<?php echo e(\Request::get('tab')); ?>";
 ...
 <script>
    function removeSelectedPreference(varientID, type){
        ...
        if (type == "daily") {
            ...
            url = "<?php echo e(url('/update-subcart')); ?>";
        }
...
function addCard() {
    ...
    jQuery.ajax({
        ...
        data: {
            addedFrom:'cart',
             tab:"<?php echo e(\Request::get('tab')); ?>",
            _token: _token,
        },
        success: function(result) {
...
if (productModel.isautorenew === "yes" && checkbox) {
    ...
    // Call backend
    jQuery.ajax({
        url: "<?php echo e(ENV('APP_URL')); ?>showWeekListA",
        method: "POST",
        data: {
        ...
        jQuery.ajax({
            ...
            success: function(result) {
                ...
                fbq('track', 'AddToCart', {
                    ...
                    localStorage.setItem("selectedTab", "2");
                   window.location.href = "<?php echo e(env('APP_URL')); ?>cart?tab=2";
                } else {
                    Swal.fire({
                    title: result.message,
                    icon: "error",
...
<?php if(isset($subCartProductList['data']) && is_array($subCartProductList['data'])): ?>
<script>
function setMinDate() {
    const today = new Date();
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    function updateCartQuantity(productString, quantity) {
        ...
        var _token = jQuery('meta[name="csrf-token"]').attr('content');
        var url = "<?php echo e(ENV('APP_URL')); ?>add-to-cart";
        $("#ajaxLoader").show();
        jQuery.ajax({
            url: url,
            method: "POST",
...
<script>
let baseTotal = parseFloat("<?php echo e($subCartProductList['data']['total_price'] ?? 0); ?>");
let walletB = parseFloat("<?php echo e($subCartProductList['data']['wallet_balance'] ?? 0); ?>")
...
function checkOutSubCartApiCall() {
    ...
    let currentDateTime = new Date();
    let products = <?php echo json_encode($subCartProductList['data']['data'], 15, 512) ?>;
    let isRequired = 0;
    isPastDate = 0
    ...
    if (addressID1 !== "" && siNO !== "" && isRequired !== 1 && isPastDate !== 1) {
        $("#ajaxLoader").show();
        var _token = jQuery('meta[name="csrf-token"]').attr('content');
        var url = "<?php echo e(ENV('APP_URL')); ?>checkoutsubcribtionorder";
        jQuery.ajax({
            url: url,
            method: "POST",
            data: {
                ...
                gtag('event', 'begin_checkoutSubscriptionW', {
                    ...
                    debug_mode: false // true for DebugView testing
                     ...
                     navigateToNextPage(href =
                                "<?php echo e(ENV('APP_URL')); ?>order-complete?screen=subscription");
                }
            },
            error: function(xhr, status, error) {
                $("#ajaxLoader").hide();
        ...
        Swal.fire({
            title: "<?php echo e(ENV('CHECKPASSEDDATE')); ?>",
            icon: "warning",
            draggable: true
        });
    } else if (addressID1 === "") {
...
function checkOutSubCartPaymentApiCall(btnType) {
   ...
   let orderInstruction = document.getElementById("orderInstruction").value;
    ...
    if (addressID !== "" && isRequired !== 1 && isPastDate !== 1) {
        $("#ajaxLoader").show();
        var _token = jQuery('meta[name="csrf-token"]').attr('content');
        var url = "<?php echo e(ENV('APP_URL')); ?>checkoutPaymentSubcribtionOrder";
        ...
        jQuery.ajax({
            ...
            success: function(result) {
                ...
                gtag('event', 'begin_checkoutSubscriptionW', {
                    ...
                    navigateToNextPage(href = result.action);
                    // navigateToNextPage(href = "<?php echo e(ENV('APP_URL')); ?>order-complete?screen=subscription");
                } else {
                    Swal.fire({
                        icon: "sucess",
                        title: result.message,
...
function saveSelectedDateTimeApiCall(selectedBtn, type) {
    ...
    var url = "<?php echo e(ENV('APP_URL')); ?>saveSelectedDateTimeDB";
    $("#ajaxLoader").show();
    $.ajax({
        url: url,
        method: "POST",
        ...
        success: function(result) {
            ...
            if (selectedBtn == "save") {
                ...
                window.location.href = "<?php echo e(env('APP_URL')); ?>cart?tab="+tab_list;
            } else {
                console.log("G1------->2");
...
function fetchCouponList() {
    $("#ajaxLoader").show();
    var _token = jQuery('meta[name="csrf-token"]').attr('content');
    var url = "<?php echo e(url('/showCouponlist')); ?>";
...
function applyCouponAPICall(couponCode) {
    ...
    // console.log("Data Sent to Server:", dataarray);
    var url = "<?php echo e(ENV('APP_URL')); ?>applyCouponCall";
    $("#ajaxLoader").show();
    $.ajax({
        url: url,
        method: "POST",
...
let walletD = parseFloat("<?php echo e($showCartProductList['data']['wallet_balance'] ?? 0); ?>")
...
let showCartData = <?php echo json_encode($showCartProductList['data'] ?? [], 15, 512) ?>;
// < !--checkout subcart api call...G1-- >
...
function checkOutDailyCartApiCallWithData() {
    ...
    var _token = jQuery('meta[name="csrf-token"]').attr('content');
    var url = "<?php echo e(ENV('APP_URL')); ?>checkoutdailyorder";
    $("#ajaxLoader").show();
    jQuery.ajax({
        url: url,
        method: "POST",
        ...
        success: function(result) {
            ...
            if (result.success === '1') {
               ...
               navigateToNextPage(href = "<?php echo e(ENV('APP_URL')); ?>order-complete?screen=daily");
            } else {
                Swal.fire({
                    icon: "sucess",
                    title: result.message,
...
function checkOutDailyCartPaymentApiCall(btnType) {
    ...
    $("#ajaxLoader").show();
    var _token = jQuery('meta[name="csrf-token"]').attr('content');
    var url = "<?php echo e(ENV('APP_URL')); ?>checkoutpaymentdailyorder";
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    addressModal.addEventListener("hidden.bs.modal", function() {
        document.body.style.overflow = "";
        if(addedFrom == 'cart'){
            window.location.href="<?php echo e(url('cart?tab='.\Request::get('tab'))); ?>"
        }
    });
    ...
    let nTitle = <?php echo json_encode($title, 15, 512) ?>;
    //  console.log("G1------>title",nTitle);

     if (nTitle === 'daily') {
        let showCartProductList = <?php echo json_encode($showCartProductList, 15, 512) ?>;
       if (showCartProductList.data.lastadd && showCartProductList.data.lastadd.length > 0) {
         ...
         let subCartProductList = <?php echo json_encode($subCartProductList, 15, 512) ?>;
                ...
                <div class="subscription_selectDetails_box">
                    <div class="repeatDays_box">
                        <div class="order-subheading d-flex justify-content-between align-items-center">
                            <div class="headingBox">
                                <img src="<?php echo e(asset('assets/images/calender.png')); ?>" alt="" class="img-fluid"
                    ...
                    <div class="subscription_duration" id="weekModel">
                        <div class="order-subheading d-flex">
                            <img src="<?php echo e(asset('assets/images/Certificate.png')); ?>" alt="" class="img-fluid"
                                style="max-width:25px">
                            <div class="head">
                    ...
                    <div class="subscription_duration d-flex justify-content-between align-items-center">
                        <div class="order-subheading d-flex">
                            <img src="<?php echo e(asset('assets/images/calender-black.png')); ?>" alt="" class="img-fluid"
                                style="max-width:25px">
                            <div class="head">
...
</div><?php /**PATH /home/demoquickart2/public_html/quickart_web/resources/views/Cart/cart.blade.php ENDPATH**/ ?>