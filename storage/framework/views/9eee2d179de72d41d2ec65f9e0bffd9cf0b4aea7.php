        ...
        <div class="row justify-content-center">
            <div class="col-lg-6">
                <div class="order_confirmed_box">
                    ...
                    <?php if(\Request::get('screen') == 'daily' && !empty($CartCount) && !empty($CartCount['subscriptioncartCount'])): ?>
                        <p>You're almost done! Your Daily Cart is checked out. Complete your order by checking out your
                            Subscription Cart.</p>
                    <?php endif; ?>
                    <?php if(\Request::get('screen') == "subscription" && !empty($CartCount) && !empty($CartCount['dailycartCount'])): ?>
                    ...
                    <div class="btn_wrap">
                        <a class="button continue_btn" href="<?php echo e(ENV('APP_URL')); ?>">Continue Shopping</a>
                    </div>
                </div>
            </div>
        </div>
