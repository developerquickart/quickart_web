...
<div class="all_product_list">
    <div class="item">
        <div class="product">
            ...
            <a href="<?php echo e(url('product-details')); ?>?name=<?php echo e(Str::slug($product['product_name'])); ?>&id=<?php echo e(trim($product['product_id'])); ?>">
                <div class="product-img">
...
<?php endif; ?>
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
<?php /**PATH /home/demoquickart2/public_html/quickart_web/resources/views/CategoryProduct/product-list-partial.blade.php ENDPATH**/ ?>