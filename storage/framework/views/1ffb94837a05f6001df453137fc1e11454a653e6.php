                    ...
                    <div class="col-lg-12">
                        <div class="cart_tabbing_mainBox">
                            <div class="all_categories_listing_mainBox mt-4">
                                <?php if(isset($subCatList['data']) && count($subCatList['data']) > 0): ?>
                                <div class="left_subCate_listingMainBox">
                                    <ul class="sub_cate_nav" id="pills-tab" role="tablist">
                                        ...
                                        <a class="all_cate_subCate_list"
                                            onclick="SubCategoryList('<?php echo e($subcat['id']); ?>', '<?php echo e($subcat['title']); ?>');"
                                            href="<?php echo e(ENV('APP_URL')); ?>featured-categories-product-list/<?php echo e($subcat['id']); ?>/<?php echo e(Str::slug($subcat['title'])); ?>">
                                            <li class=" nav-item" role="presentation">
                                                <button
                                                    class="nav-link <?php echo e($subcat['id'] == $defaultSubCatId ? 'active' : ''); ?>"
                                                    id="categories<?php echo e($subcat['id']); ?>" data-bs-toggle="pill"
                                                    data-bs-target="#categories_box<?php echo e($subcat['id']); ?>" type="button"
                                                    role="tab" aria-controls="categories_box<?php echo e($subcat['id']); ?>"
                                                    aria-selected="<?php echo e($subcat['id'] == $subcat['id'] ? 'true' : 'false'); ?>">
                                ...
                                <div class="right_subCate_listingMainBox">
                                     <input type="hidden" name="fcategory_id" id="fcategory_id" value="<?php echo e(\Request::get('fid')); ?>" />
                                    <div class="section-header">
                                        <h5 class="heading-design-h5" id='selectedCatID'><?php echo e(str_replace('-',' ',$Sub_cat_name)); ?> Category
                                        </h5>
                                    </div>
                                     <?php if(isset($productList['data']) && count($productList['data']) > 0): ?>
                                        <div id="featuredproductList">
                                            <div class="product_list_box">
                                                <?php echo $__env->make('CategoryProduct.featured-categories-product-list-partial', ['productList' => $productList['data']], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                            </div>
                                        </div>
                                        <?php else: ?>
...
$(document).ready(function () {
 ...
 function loadMoreData(page,loadSubcategory) {
        ...
        $.ajax({
            url: '<?php echo e(url("featured-categories-product-list")); ?>',
            type: "get",
...
function SubCategoryList(id, title) {
    ...
    // jQuery.ajax({
    //     url: "<?php echo e(url('selected-featured-categories-product-list')); ?>",
    //     method: "POST",
    //     data: {
    //         fid: id,
    //         title: title,
...
<?php /**PATH /home/demoquickart2/public_html/quickart_web/resources/views/CategoryProduct/featured-categories-product-list.blade.php ENDPATH**/ ?>