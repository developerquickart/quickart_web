                            ...
                            <div class="cart_tabbing_content" id="content">
                                <div id="1" class="tabcontent">
                                    <div class="content_Mainbox">
                                        <?php if(isset($dailyOrderList['status']) == 1): ?>
                                        <?php if(!empty($dailyOrderList['data'])): ?>
                                                        ...
                                                        <div class="order_info">
                                                            <div class="order_details">
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-lg-6 col-md-6 text-end">
                                                                        <div class="cancel_order_btn">
                                                                            <div class="daily-order-status-btn"
                                                                                style="color: <?php echo e(getProdOrderStatusColor($orderList['order_status'])); ?>;"> 
                                                                                <?php echo e($orderList['order_status'] == 'Out_For_Delivery' ? "Out For Delivery": getOrderStatus($orderList['order_status'])); ?>
                                                                    ...
                                                                    <div class="col-lg-12">
                                                                        <ul>
                                                                            <li><?php echo e($orderList['productname']); ?></span>
                                                                            </li>
                                                                        </ul>
                                                                    </div>
                                                                </div>
                                ...
                                <div id="2" class="tabcontent" style="display: none;">
                                    <div class="content_Mainbox">
                                        <?php if(isset($subscriptionOrderList['status']) == 1): ?>
                                        <?php if(!empty($subscriptionOrderList['data'])): ?>
                                        <div class="sub_order_listBox my-order-mainList">
                                            ...
                                            <div class="sub_order_list my-order-list">
                                                <div class="sub_order_details">
                                                    ...
                                                    <!--    onclick="navigateToNextPage('<?php echo e(url(ENV('APP_URL') . 'subscription-order-product?group_id=' . $orderList['group_id'])); ?>')">-->
                                                    <a class="orderBox_box" href="<?php echo e(url(ENV('APP_URL') . 'subscription-order-product?group_id=' . $orderList['group_id'])); ?>" >
                                                    ...
                                                    <div class="col-lg-12">
                                                        ...
                                                        <?php if(isset($orderList['order_status']) && $orderList['order_status'] == 'Completed'): ?>                                                        
                                                        <div class="buyAgain_btn" onclick="buyAgain('<?php echo e($orderList['group_id']); ?>')">
                                                            <img src="<?php echo e(asset('assets/images/buyagain.png')); ?>"
                                                                alt="buyAgain" class="img-fluid">
                                                            Buy Again</div>
                                                        <?php endif; ?>
                                                        <?php if(isset($orderList['si_order']) && $orderList['si_order'] == 'yes' && $orderList['order_status'] != 'Completed' && $orderList['order_status'] != 'Cancelled'): ?>
                                                        <div class="change_card" data-bs-toggle="modal"
                                                            data-bs-target="#cardModal"
                                                            onclick="fetchCardList('<?php echo e($orderList['si_sub_ref_no']); ?>', '<?php echo e($orderList['cart_id']); ?>')">
                                                            <img src="<?php echo e(asset('assets/images/card.png')); ?>" alt="card"
                                                                class="img-fluid">Change Card
                                                        </div>
                                                        <?php endif; ?>
                                                        <?php if(isset($orderList['order_status']) &&
                                                        ...
                                                        ?>
                                                        <a href="<?php echo e(ENV('APP_URL')); ?>rating-reviews?screenName=subreview&data=<?php echo e($encodedData1); ?>">
                                                ...
                                                <div class="sub_order_priceBox"
                                                    ...
                                                    <div class="priceBox">AED
                                                        <span><?php echo e(number_format($orderList['total_mrp'], 2)); ?></span>
                                                    </div>
                                                </div>
                                                <div class="view_box"
                                                    onclick="navigateToNextPage('<?php echo e(url(ENV('APP_URL') . 'subscription-order-product?group_id=' . $orderList['group_id'])); ?>')">
...
<div class="modal fade" id="cardModal" tabindex="-1" aria-labelledby="cardModalLabel" aria-hidden="true">
    ...
    <div id="loader" style="display: flex; justify-content: center; align-items: center;">
        <img src="<?php echo e(asset('assets/images/loader.gif')); ?>" alt="Loading..." class="img-fluid" style="max-width:10%" />
    </div>
    <script>
...
//    console.log("sgroup_id", gid);
        jQuery.ajax({
            ...
            success: function (result) {
                ...
                navigateToNextPage(href="<?php echo e(ENV('APP_URL')); ?>cart?tab=2");
            },
            error: function (xhr, status, error) {
                console.error("XHR:", xhr);
                console.error("Status:", status);
...
</script><?php /**PATH /home/demoquickart2/public_html/quickart_web/resources/views/Orders/my-orders.blade.php ENDPATH**/ ?>