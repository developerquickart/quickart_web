                ...
                <aside id="sidebar" class="sidebar break-point-sm has-bg-image">
                    <nav class="menu open-current-submenu">
                        <div id="side-menu">
                            ...
                            <div class="menu_item">
                                <div class="sub-menu-list">
                                    <a href="<?php echo e(ENV('APP_URL')); ?>my-order" class="sub-menu-list-link">My Order</a>
                                </div>
                            </div>
                            <div class="menu_item">
                                <div class="sub-menu-list">
            ...
            <div class="rating_review_mainbox">
                ...
                <div class="contentData">
                    ...
                    <div class="form_links d-flex align-items-center">
                        <img src="<?php echo e(asset('assets/images/contact_call.png')); ?>" alt="Call">
                        <a href="tel:+97142390322">971 42390322</a>
                    </div>
                    <div class="form_links d-flex align-items-center">
                        <img src="<?php echo e(asset('assets/images/contact_mail.png')); ?>" alt="Email">
                        <a
                            href="mailto:customersupport@quickart.ae">customersupport@quickart.ae</a>

                    </div>
                    <div class="form_links d-flex align-items-center">
                        <img src="<?php echo e(asset('assets/images/contact-whatsapp.png')); ?>"
                            alt="Whatsapp">
                    ...
                    <div class="form_links d-flex align-items-center">
                        ...
                        <a href="https://www.tiktok.com/@quickartuae?_t=8p59LunNyCH&_r=1" target="_blank">
                            <img src="<?php echo e(asset('assets/images/contact-tiktok.png')); ?>"
...
<?php echo $__env->make('footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/demoquickart2/public_html/quickart_web/resources/views/Profile/help.blade.php ENDPATH**/ ?>