                    ...
                    <div class="all_product_list">
                        <div class="product">
                            <div class="product_header">
                                <div class="product_top_left">
                                    <?php if($product['discountper'] > 0): ?>
                                    <div class="discount_text"><?php echo e(number_format($product['discountper'], 0)); ?>%<span>Off</span>
                                    </div>
                                    <?php endif; ?>
                            ...
                            <div class="product-body notify_box">
                                <div class="product-body">
                                    <div class="product_name" style="color: white;"><?php echo e($product['product_name']); ?></div>
                                    <div class="product_weight1"><span><?php echo e($product['quantity']); ?> <?php echo e($product['unit']); ?></span></div>
                                </div>
...
function removeNotifyMe(element) {
    ...
    var url = "<?php echo e(ENV('APP_URL')); ?>RemoveNotifyMe";
    ...
    jQuery.ajax({
        ...
        success: function(result) {
            window.location.href = "<?php echo e(ENV('APP_URL')); ?>notify";
        },
...
<?php echo $__env->make('footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/demoquickart2/public_html/quickart_web/resources/views/notify.blade.php ENDPATH**/ ?>