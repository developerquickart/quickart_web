            ...
            <?php if(isset($productList['data']) && count($productList['data']) > 0): ?>
              <div id="productList">
                <div class="product_list_box">
                 <?php echo $__env->make('CategoryProduct.additional-categories-partial', ['productList' => $productList['data']], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                 </div>
            </div>
            <div class="ploader">
...
<script>
 ...
 // ($(window).scrollTop() + $(window).height() >= $(document).height() - 100) 
    function loadMoreData(page) {
        ...
        $.ajax({
            url: '<?php echo e(url("additional-categories")); ?>',
            type: "get",
...
<?php echo $__env->make('footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/demoquickart2/public_html/quickart_web/resources/views/CategoryProduct/additional-categories.blade.php ENDPATH**/ ?>