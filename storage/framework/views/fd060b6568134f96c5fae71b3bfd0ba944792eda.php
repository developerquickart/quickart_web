                                                            ...
                                                            <div class="coupon_code_data">
                                                                <div class="coupon_code">
                                                                    <div class="coupon_img">
                                                                        <img src="<?php echo e(asset('assets/images/cred.png')); ?>"
                                                                            alt="">
                                                                    </div>
                                                    ...
                                                    <div class="coupon_item">
                                                        <div class="coupon_data">
                                                            <div class="coupon_code_data">
                                                                <div class="coupon_code">
                                                                    <div class="coupon_img">
                                                                        <img src="<?php echo e(asset('assets/images/pay.png')); ?>"
                                                                            alt="">
                                                                    </div>
                                                                    <div class="coupon_code_text" onclick="copyText()">
                                                                        QUICFTGE97</div>
...
<!-- COPY TEXT END -->
<?php echo $__env->make('footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/demoquickart2/public_html/quickart_web/resources/views/coupon.blade.php ENDPATH**/ ?>