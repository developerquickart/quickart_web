<?php if(count($productList) > 0): ?>
                            ...
                            <div class="product_top_right">
                                <div class="product_wishlist">
                                    <a href="javascript:void(0);" class="wishlist-btn"
                                        ...
                                        <img id="wishlist-<?php echo e($product['varient_id']); ?>"
                ...
                <?php endif; ?>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                <?php endif; ?><?php /**PATH /home/demoquickart2/public_html/quickart_web/resources/views/Banners/banner-product-list-partial.blade.php ENDPATH**/ ?>