    ...
    <div class="container-fluid">
        <div class="row">
            <div class="section-header">
                <h5 id="bannerHeading" class="heading-design-h5"><?php echo e(($productList['banner_detail']['banner_name'])?$productList['banner_detail']['banner_name']:''); ?></h5>
            </div>  
        </div>    
        <div class="product_list_box">
                 <?php echo $__env->make('Banners.banner-product-list-partial', ['productList' => $productList['data']], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            </div>
             <div class="ploader">
...
<script>
    ...
    function loadMoreData(page) {
        ...
        var banner_id="<?php echo e(Request::get('banner-id')); ?>";
        var banner_type="<?php echo e(Request::get('banner-type')); ?>";
        ...
        $.ajax({
            ...
            url: "<?php echo e(url('banner-product-list')); ?>"+'/'+slug,
            type: "get",
...
<?php echo $__env->make('footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/demoquickart2/public_html/quickart_web/resources/views/Banners/banner-product-list.blade.php ENDPATH**/ ?>