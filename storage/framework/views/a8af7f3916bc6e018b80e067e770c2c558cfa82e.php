            ...
            <div class="sidemenu_content_mainBox">
                <div class="content_headingBox">
                    ...
                    <div class="edit_btn" data-bs-toggle="modal" data-bs-target="#profile">
                        <img src="<?php echo e(asset('assets/images/edit.png')); ?>" alt="edit">
                    </div>
                </div>
                <?php if(isset($getUserProfile['data'])): ?>
                                ...
                                <div class="avatar-upload">
                                    <div class="avatar-preview">
                                        <div id="profileImagePreview"
                                            style="background-image: url(<?php echo e($getUserProfile['data']['user_image']); ?>);">
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="profile_formBox">
                            <fieldset class="form-group">
                                ...
                                <input type="text" name="name" id="name" class="form-control"
                                    value="<?php echo e($getUserProfile['data']['name']); ?>" disabled>
                            </fieldset>
                            <fieldset class="form-group">
                                <label for="mobile">Mobile Number</label>
                                <input type="text" name="mobile" id="mobile"
                                    class="form-control"
                                    value="<?php echo e($getUserProfile['data']['country_code']); ?> <?php echo e($getUserProfile['data']['user_phone']); ?>"
                                    disabled>
                            </fieldset>
                            <fieldset class="form-group">
                                <label for="email">Email</label>
                                <input type="email" name="email" id="email" class="form-control"
                                    value="<?php echo e($getUserProfile['data']['email']); ?>" disabled>
                            </fieldset>
                        </div>
                    </div>
                </div>
                                    ...
                                    <div class="col-lg-11">
                                        ...
                                        <fieldset class="form-group">
                                            ...
                                            <input type="name" class="form-control" id="profile-name"
                                                ...
                                                value="<?php echo e($getUserProfile['data']['name']); ?>">
                                        </fieldset>
                                        <fieldset class="form-group" data-bs-toggle="modal"
                                            ...
                                            <input type="text" class="form-control" id="profile-mobile"
                                                name="profile_mobile" maxlength="12" minlength="12" required value="<?php echo e($getUserProfile['data']['country_code']); ?> <?php echo e($getUserProfile['data']['user_phone']); ?>">
                                            <input type="hidden" name="country_code" value="<?php echo e($getUserProfile['data']['country_code']); ?>">    
                                            <input type="hidden" name="user_phone" value="<?php echo e($getUserProfile['data']['user_phone']); ?>">    
                                        </fieldset>
                                        <fieldset class="form-group" data-bs-toggle="modal"
                                            ...
                                            <input type="email" class="form-control" id="profile-email"
                                                ...
                                                required="" autocomplete="off" value="<?php echo e($getUserProfile['data']['email']); ?>">
                                        </fieldset>
                                    </div>
                                </div>
                                <div class="row">
                        ...
                        <form action="" class="update-mobile">
                            ...
                            <fieldset>
                                <!-- <input type="text" name="mobile" id="mobile" class="form-control"
                                    value="<?php echo e($getUserProfile['data']['country_code']); ?> <?php echo e($getUserProfile['data']['user_phone']); ?>" required>
 -->
                                <div class ="form-group">
                                <label for="mobile_code">Mobile Number <span
                                        class="required_icon">*</span></label>
                                <input type="text" id="mobile_code3" class="form-control"  name="mobile_code" data-index="1" required value="<?php echo e($getUserProfile['data']['user_phone']); ?>">
                                <input type="hidden" id="countryCode3" name="country_code" class="" value="<?php echo e($getUserProfile['data']['country_code']); ?>">
                                <input type="hidden" id="flagcode3" name="flag_code" class="" value="<?php echo e($getUserProfile['data']['dial_code']); ?>">
                ...
                <div class="col-lg-12">
                    <div class="loginBox text-center">
                        ...
                        <form action=" " class="update-email">
                            ...
                            <fieldset>
                                <input type="email" name="email" id="email" class="form-control"
                                    value="<?php echo e($getUserProfile['data']['email']); ?>" required>
...
$(document).ready(function() {
    ...
    $('.mobile_otp_request').on('click',function(){
            ...
            $.ajax({
              url: "<?php echo e(route('sendOtp')); ?>", // Change this to your actual URL
              type: 'POST',
    ...
    $('.update_otp_submit').on('click',function(){
                ...
                if(otp == ''){
                    ...
                    $.ajax({
                      url: "<?php echo e(route('verifyotpsubmit')); ?>", // Change this to your actual URL
                      type: 'POST',
    ...
    $('.delete_account').on('click',function(e){
        ...
        Swal.fire({
          ...
          if (result.isConfirmed) {
            ...
            $.ajax({
              url: "<?php echo e(route('userDeactivateSubmit')); ?>", // Change this to your actual URL
              type: 'POST',
              data: {
              'countryCode':<?php echo e($getUserProfile['data']['country_code']); ?>,
              'userMobile':<?php echo e($getUserProfile['data']['user_phone']); ?>,
    ...
    const selectedFlagCode = "<?php echo e($getUserProfile['data']['dial_code']); ?>";
...
<!-- PROFILE SCRIPT END -->
<?php echo $__env->make('footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/demoquickart2/public_html/quickart_web/resources/views/Profile/profile.blade.php ENDPATH**/ ?>