            ...
            <div class="col-lg-9">
                <div class="edit_address_mainBox add_address_mainBox">
                    <div class="location_map_MainBox">
                        ...
                        <div class="location_textBox">
                            ...
                            <div class="location_infoBox">
                                ...
                                <div class="location_address"><?php if(old('address') != ''): ?> <?php echo e(old('address')); ?> <?php else: ?> Please select location <?php endif; ?></div>
                            </div>
                        </div>
                    </div>
                    <div class="location_form_MainBox">
                        ...
                        <div class="form_box">
                            <form action="<?php echo e(route('get-address')); ?>" method="POST" enctype="multipart/form-data">
                                <?php echo csrf_field(); ?>
                                <div class="add_adderess_list">
                                    <fieldset class="form-group">
                                        ...
                                        <input type="text" name="house_no" id="house_no" class="form-control" value="<?php echo e(old('house_no')); ?>">
                                        ...
                                        <input type="hidden" id="addedFrom" name="addedFrom" value="<?php echo e(\Request::get('addedFrom')); ?>">
                                        <input type="hidden" id="tab" name="tab" value="<?php echo e(\Request::get('tab')); ?>">
                                    </fieldset>
                                    <fieldset class="form-group">
                                        <label for="landmark">Landmark & Area Name (Optional)</label>
                                        <input type="text" name="landmark" id="landmark" class="form-control" value="<?php echo e(old('landmark')); ?>">
                                    </fieldset>
                                </div>
                                ...
                                <div class="add_adderess_listing">
                                    <div class="add_address_radio_mainbox">
                                        <div class="add_address_radio_listing">
                                            <input type="radio" name="address_type" id="home" value="Home" <?php if(old('address_type') == 'Home'): ?> checked <?php endif; ?>>
                                            <label for="home" class="add_lable_1">Home</label>
                                        </div>
                                        <div class="add_address_radio_listing">
                                            <input type="radio" name="address_type" id="work" value="Work" <?php if(old('address_type') == 'Work'): ?> checked <?php endif; ?>>
                                            <label for="work" class="add_lable_2">Work</label>
                                        </div>
                                        <div class="add_address_radio_listing">
                                            <input type="radio" name="address_type" id="other" value="Others" <?php if(old('address_type') == 'Others'): ?> checked <?php endif; ?>>
                                ...
                                <div class="add_adderess_list">
                                    <fieldset class="form-group">
                                        ...
                                        <input type="text" name="Uname" id="Uname" class="form-control" value="<?php echo e($getUser['data']['name']); ?>">
                                    </fieldset>
                                    ...
                                    <fieldset class="form-group">
                                        <div class="mobile_number_country_box">
                                            <div id="phone-container" class="input-group-1">
                                                ...
                                                <input type="text" class="form-control" id="addnumber" name="number" value="<?php echo e($getUser['data']['user_phone']); ?>" formControlName="mobile">
                                                <!-- Hidden input for the country code -->
                                                <input type="hidden" id="addcountryCode" name="country_code" value="<?php echo e(old('country_code')); ?>">
                                                <input type="hidden" id="addflagcode" name="flagcode" value="<?php echo e(old('flagcode')); ?>">
                                                <input type="hidden" id="address" name="address" value="<?php echo e(old('address')); ?>">
                                    ...
                                    <fieldset class="form-group">
                                        ...
                                        <input type="email" name="email" id="email" class="form-control" value="<?php echo e($getUser['data']['email']); ?>">
                                    </fieldset>
                                    <fieldset class="form-group">
...
<?php if($getUser['data']['dial_code'] != ''): ?> 
var ccountry_code = "<?php echo e($getUser['data']['dial_code']); ?>";
<?php else: ?>
...
<?php /**PATH /home/demoquickart2/public_html/quickart_web/resources/views/Address/add-address.blade.php ENDPATH**/ ?>