        ...
        <div class="row">
                ...
                <div class="col-lg-12">
                    ...
                    <div class="trial_pack_mainbox">
                        <?php $__currentLoopData = $productList['data']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $productListT): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="trial_pack_listing">
                                <div class="tial_pack_img">
                                    <img src="<?php echo e($productListT['image']); ?>" alt="Trial Pack Images" class="img-fluid">
                                </div>
...
<script>
    ...
    function ShowTrailPackProduct(trialPID, title) {
        ...
        var url = "<?php echo e(ENV('APP_URL')); ?>showTrialPackProduct";
...
<?php echo $__env->make('footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/demoquickart2/public_html/quickart_web/resources/views/Trailpack/trial-pack.blade.php ENDPATH**/ ?>