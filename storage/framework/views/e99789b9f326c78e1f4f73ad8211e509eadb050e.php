<input type="hidden" name="totalPages" id="totalPages" value="<?php echo e($productList[0]['totalPages'] ?? 1); ?>" />
    ...
    <div class="product" data-productDetail='<?php echo json_encode($product, 15, 512) ?>'data-product-id="<?php echo e(trim($product['product_id'])); ?>">
        ...
        <a href="<?php echo e(url('product-details')); ?>/<?php echo e(Str::slug($product['product_name'])); ?>/<?php echo e(trim($product['product_id'])); ?>">
            <div class="product-img">
                <img class="img-fluid" src="<?php echo e($product['product_image']); ?>"
                    alt="">
            </div>
        ...
        <div class="product-footer">
            <div class="product_detail">
                ...
                <?php else: ?>
                <p class="offer-price">AED
                    <?php echo e(number_format($product['price'], 2)); ?><br><span
                        class="regular-price">AED
                        <?php echo e(number_format($product['mrp'], 2)); ?></span>
                </p>
                <?php endif; ?>
            </div>
    ...
    <div class="item">
        <div class="product">
            ...
            <a href="<?php echo e(url('product-details')); ?>/<?php echo e(Str::slug($product['product_name'])); ?>/<?php echo e(trim($product['product_id'])); ?>">
                <div class="product-img">
                    <img class="img-fluid"
                        src="<?php echo e($product['product_image']); ?>" alt="product">
                </div>
            </a>
...
<?php endif; ?>
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            <?php /**PATH /home/demoquickart2/public_html/quickart_web/resources/views/CategoryProduct/featured-categories-product-list-partial.blade.php ENDPATH**/ ?>