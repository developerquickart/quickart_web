...
class ProductController extends Controller
{
    ...
    // Set all additonal categroy product list...G1
     public function additionalProductList(Request $request)
    {
        ...
        $perpage = 20;
            ...
            $name = $request->name;
            // $name = ucwords(strtolower(str_replace('+', ' ', $request->name)));
            // $name = ucwords(str_replace('-', ' ', Str::slug($name)));
            $name = ucwords(str_replace('-', ' ', $name));
            // $name = "fresh food";
            if($request->name == "Fresh-Picks") {
            $name = "Fresh picks";
            }
        ...
        if ($request->ajax()) {
            ...
            $productList = $productList['data'];
            return view('CategoryProduct.additional-categories-partial', compact('productList'));
            
        }
        return view('CategoryProduct/additional-categories', compact('title', 'data_arr', 'productList', 'name'));
    }

     // Set all brand product list...G1
     public function brandProductList(Request $request)
    {
        ...
        if ($request->ajax()) {
            // Product List by Brands api call
                ...
                $productList = $productList['data'];
            return view('CategoryProduct.brand-product-list-partial', compact('productList'));
            
        }
        return view('CategoryProduct/brand-product-list', compact('title', 'data_arr', 'productList', 'name'));
    }
    
       // Set all occasional product list...G1
      public function OccasionalProductList(Request $request)
    {
        $title = "Quickart-category";
        $data_arr = array();
        $data_arr['title'] = "Quickart";
        ...
        if ($request->ajax()) {
            ...
            $productList = $productList['data'];
            return view('CategoryProduct.occasional-product-list-partial', compact('productList'));
        
        }

        return view('CategoryProduct/occasional-product-list', compact('title', 'data_arr', 'productList', 'name'));
    }

      public function TopSellingProductList(Request $request)
    {
        ...
        if ($request->ajax()) {
            ...
            $productList = $productList['data'];
            return view('CategoryProduct.top-selling-product-list-partial', compact('productList'));
        
        }

        return view('CategoryProduct/top-selling-product-list', compact('title', 'data_arr', 'productList', 'name'));
    }
       // Set all top feature category product product list...G1
   ...
   // Set all recent selling product list...G1
       public function RecentSellingProductList(Request $request)
    {
        ...
        if ($request->ajax()) {
            ...
            $productList = $productList['data'];
            return view('CategoryProduct.recent-selling-product-list-partial', compact('productList'));
        
        }

        return view('CategoryProduct/recent-selling-product-list', compact('title', 'data_arr', 'productList', 'name'));
    }
    ...
    public function searchProductList(Request $request)
    {
     ...
     // Autosuggest api name list call...G1
    public function searchProductsName(Request $request)
    {
        ...
        $productList = array();
         ...
         try {
                $client = new Client();
                $response = $client->post($nodeappUrl . 'similarproduct', [
                    'json' => [
                        "store_id" => $store_ID,
                        "user_id" => $user_ID,              
                        "keyword" => $keyword,
