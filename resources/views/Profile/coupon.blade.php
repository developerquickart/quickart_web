        ...
        <div class="sidemenu_mainBox">
            ...
            <div class="coupon_listing_box">
                ...
                <div class="coupon_item_list">
                    @foreach($couponList['data'] as $couponModel)
                    <div class="coupon_item">
                        <div class="coupon_data">
                            <div class="coupon_code_data">
                                <div class="coupon_code">
                                    <div class="coupon_img">
                                        <a data-fancybox="coupon" data-src="{{$couponModel['coupon_image']}}"
                                            data-caption="{{$couponModel['coupon_description']}}">
                                            <img src="{{$couponModel['coupon_image']}}" alt="">
                                        </a>
                                    </div>
                                    <div class="coupon_code_text" >
                                        {{$couponModel['coupon_code']}}
                                    </div>
                                </div>
                            </div>
                            <p>{{$couponModel['coupon_description']}} </p>
                        </div>
                        <div class="coupon_details">
                            <div class="coupon_details_text">
                                Use code
                                <strong>{{$couponModel['coupon_name']}}
                                    ({{$couponModel['coupon_code']}})</strong> to get
                                @if($couponModel['type'] == "percentage")
                                <strong>{{$couponModel['amount']}}%</strong>
                                @else
                                <strong>{{$couponModel['amount']}} AED</strong>
                                @endif
                                off on your order .
                            </div>
                        </div>
