...
<section class="section-padding">
    ...
    <div class="sidemenu_mainBox">
            ...
            <div class="sidemenu_content_mainBox">
                ...
                @if(isset($cardList['data']) && count($cardList['data']) > 0)
                <div class="card_details_mainBox">
                    <div class="card_order_box">
                        <div class="row">
                            @foreach($cardList['data'] as $cardList)
                            <div class="col-lg-4">
                                <div class="payment_method">
                                    <label class="payment_option cards" for="card1">
                                        <div style="display: flex; justify-content: space-between;">
                                            ...
                                            <div class="card_remove" onclick="removeCardAlert('{{$cardList['id']}}')">
                                                <img src="{{asset('assets/images/delete.svg')}}" alt="Removed">
                                            </div>
                                        </div>
                                        @if ($cardList['si_sub_ref_no'] == $siNo)
                                        <div data-subref="{{ $cardList['si_sub_ref_no'] }}"
                                            data-cardno="{{ $cardList['card_no'] }}"></div>
                                        @else
                                        <div data-subref="{{ $cardList['si_sub_ref_no'] }}"
                                            data-cardno="{{ $cardList['card_no'] }}"> </div>
                                        @endif
...
function removeCard(bankId) {
    ...
    var url = "{{ENV('APP_URL')}}removeCardAPICall";
