...
<body>
            ...
            <div class="container-fluid">
                <div class="headerBox">
                    ...
                    <div class="header_icons_box">
                        <div class="searchBox">
                            <form action="{{ENV('APP_URL')}}search" method="GET" class="search-box">
                                ...
                                <button class="btn search_buttonBox" type="submit"> <img
                                        src="{{asset('assets/images/search_icon.png')}}" alt="search"
                                        class="img-fluid search_icon"></button>
                                <!-- <a href="{{ENV('APP_URL')}}" class="cancel-button">Cancel</a> -->
                            </form>
                        </div>
                            ...
                            <div class="login_cartbox text-end">
                                ...
                                <div class="main_menu_mobile">
                                    <ul class="main-mobile-nav">
                                        ...
                                        <li class="list-inline-item">
                                            <a href="{{ENV('APP_URL')}}profile?tag=6" class="top_icon">
                                                <div class="top_other_icon_img">
                                                    <img src="{{asset('assets/images/menu_order.png')}}" alt="Signin">
                                                </div>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="search-item">
                    @foreach($recentSearch as $recentsearch)
                    <a href="{{ENV('APP_URL')}}search?keyword={{Str::slug($recentsearch['keyword'])}}" class="search_item_list">
                        <span class="search-text"><span class="icon">&#x21bb;</span>
                            {{$recentsearch['keyword']}}</span>
                    </a>
                    @endforeach
                </div>
            </div>
                ...
                <div class="col-lg-12">
                    ...
                    <div class="brand-slider-wrapper">
                        <div class="owl-carousel owl-carousel-brands owl-theme">
                            @foreach(array_slice($brandList, 0,ceil(count($brandList) / 2)) as $brand)
                            <div class="brand_list_item">
                                <div class="brand_item_box">
                                    <a href="{{ENV('APP_URL')}}search?name={{ Str::slug($brand['title']) }}">
                        ...
                        <div class="owl-carousel brand-slider owl-theme"> -->
                            @foreach(array_slice($brandList,ceil(count($brandList) / 2)) as $brand)
                            <div class="brand_list_item">
                                <div class="brand_item_box">
                                    <a href="{{ENV('APP_URL')}}search?name={{ Str::slug($brand['title'])  }}">
                                        <img class="img-fluid" src="{{$brand['image']}}" alt="Product">
    ...
    <section class="shop-list section-padding">
        <div class="container-fluid">
            <div class="row">
                <div class="section-header">
                    <h5 class="heading-design-h5">{{$name}}</h5>
                </div>

                <!-- <div class="owl-carousel product-slider owl-theme">
                    @foreach(array_slice($productList, 0, ceil(count($productList) / 2)) as $product)
                    @if(!$product['stock'] == 0)
                    <div class="item">
                        <div class="product">
                            <div class="product_header">
                                ...
                                <div class="product_top_right">
                                    <div class="product_wishlist">
                                        <a href="javascript:void(0);" class="wishlist-btn" data-varient-id="{{ $product['varient_id'] }}">
                            ...
                            <a href="{{ENV('APP_URL')}}product-details?product_id={{$product['product_id']}}">
                                <div class="product-img">
                                    <img class="img-fluid" src="{{$product['product_image']}}" alt="Product">
                                </div>
                                ...
                                <div class="row align-items-center">
                                    <div class="col-6">
                                        <div class="product_detail">
                                            <p class="offer-price">AED <span>{{number_format($product['price'], 2)}}</span><br>
                                    ...
                                    <div class="col-6">
                                        <div class="cart_btn">
                                            <div class="qtyBox" data-varient-id="{{ $product['varient_id'] }}">
                                                <button class="qty-btn qty-btn-minus change-qty" type="button" data-varient-id="{{ $product['varient_id'] }}" data-change="-1">-</button>
                                                <input type="text" name="qty" value="{{ $product['cart_qty'] }}" class="input-qty input-rounded" min="0">
                                                <input type="hidden" name="stock" id="stock" value="{{ $product['stock'] }}">
                                                <button class="qty-btn qty-btn-plus change-qty" type="button" data-varient-id="{{ $product['varient_id'] }}" data-change="1">+</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="product_header">
                                ...
                                <div class="product_top_right">
                                    ...
                                    <div class="product_wishlist">
                                        ...
                                        <a href="javascript:void(0);" class="notify-me" data-varient-id="{{ $product['varient_id'] }}" data-product-id="{{ $product['product_id'] }}">
                    ...
                    <div class="item">
                        <div class="product">
                            ...
                            <a href="{{ url('product-details') }}/{{ Str::slug($product['product_name']) }}/{{ trim($product['product_id']) }}">
                                ...
                                <div class="product-body">
                                    <div class="product_name">{{$product['product_name']}}</div>
                                    <div class="product_weight"><span>{{$product['quantity']}}
                            ...
                            <div class="product-footer">
                                ...
                                <div class="cart_btn">
                                    <div class="qtyBox" data-varient-id="{{ $product['varient_id'] }}">
                                        ...
                                        <input type="text" name="qty" value="{{ $product['cart_qty'] }}"
    ...
    <section class="shop-list section-padding">
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="search-item">
                    @foreach($recentSearch as $recentsearch)
                        @if(!empty($recentsearch['keyword']) || $recentsearch['keyword'] != '')
                        <a href="{{ENV('APP_URL')}}search?keyword={{Str::slug($recentsearch['keyword'])}}" class="search_item_list">
                            <span class="search-text"><span class="icon">&#x21bb;</span>
                                {{$recentsearch['keyword']}}</span>
                        </a>
