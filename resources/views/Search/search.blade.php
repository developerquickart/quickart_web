...
@include('header')
    ...
    <section class="shop-list section-padding">
        <div class="container-fluid">
            <div class="row">
                @if(isset($searchbysort['data']) && count($searchbysort['data']) > 0)
                <div class="product_list_box">
                    @include('Search.search-partial', ['productList' => $searchbysort['data']])
               </div>
               <div class="ploader">
                        ...
                        <div class="row align-items-center justify-content-center">
                            <div class="col-lg-6">
                                <div class="data_not_available">
                                    <div class="imageBox">
                                        <img src="{{asset('assets/images/No_search_data_available.svg')}}"
    ...
    let totalPages = '{{$searchbysort['data'][0]['totalPages'] ?? 1}}';
