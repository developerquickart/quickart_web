                    ...
                    <div class="col-lg-12">
                        <div class="cart_tabbing_mainBox">
                            ...
                            <div class="cart_tabbing_content" id="content">
                                ...
                                @if(isset($subCartProductList['status']) == 1)    
                                @if(isset($subCartProductList['data']))
                                <div class="content_Mainbox">
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <div class="cart_left_mainbox position__sticky1">
                                                    ...
                                                    <div class="car_product_list_mainBox">
                                                        @foreach($subCartProductList['data']['data'] as $product)
                                                        <div class="car_product_list">
                                                            <div class="ordered_product">
                                                                <div class="product_imgbox">
                                                                     <a href="{{ url('product-details') }}/{{ Str::slug($product['product_name']) }}/{{ trim($product['product_id']) }}">
                                                                ...
                                                                <div style="width:100%;">
                                                                        ...
                                                                        <div class="order_info" style="width:100%;">
                                                                            <div class="order-namingBox">
                                                                                ...
                                                                                <div class="item">
                                                                                    <div class="priceBox text-end">
                                                                                        <div class="actual_price">AED
                                                                                            <span>{{number_format($product['subscription_price'], 2)}}</span>
                                                                                        </div>
                                                                                        <div class="mrp_price">
                                                                        ...
                                                                        <div class="order_details mt-2">
                                                                            <div class="row g-0">
                                                                                <div class="col-6">
                                                                                    ...
                                                                                    <div class="feature_txt">
                                                                                        <span>{{$product['product_feature_value']}}</span>
                                                                                        <span><img src="{{asset('assets/images/remove01.png')}}" alt="close" class="img-fluid varient_close_btn" onclick='removeSelectedPreference("{{ $product["varient_id"] }}", "subscription")'></span>
                                                                                    </div>
                                                                                    @endif
                                                                                </div>
                                                                                <div class="col-6">
                                                                                    <div class="sub_btn_mainBox">
                                                                                        <div class="">
                                                                                            <div class="cart_btn2">
                                                                                                <div class="qtyBox"
                                                                                                    data-product='@json($product)'>
                                                                                                     <button  class="qty-btn qty-btn-minus" onclick="removeToSubCartCall('{{ $product['varient_id']}}', 'minus', '{{ $product['cart_qty']}}', '{{ $product['sub_time_slot']}}', '{{ $product['sub_total_delivery']}}', '{{ $product['sub_delivery_date']}}', '{{ $product['repeat_orders']}}', '{{ $product['isautorenew']}}','{{ $product['product_name']}}','{{ $product['price']}}', '{{ $product['product_feature_id']}}')">-</button>
                                                                                                     <input type="text"
                                                                                                        name="qty"
                                                                                                        value="{{ $product['cart_qty'] }}"
                                                                                                        class="input-qty input-rounded"
                                                                                                        min="1">
                                                                                                     <button class="qty-btn qty-btn-plus" onclick="removeToSubCartCall('{{ $product['varient_id']}}', 'plus', '{{ $product['cart_qty']}}', '{{ $product['sub_time_slot']}}', '{{ $product['sub_total_delivery']}}', '{{ $product['sub_delivery_date']}}', '{{ $product['repeat_orders']}}', '{{ $product['isautorenew']}}','{{ $product['product_name']}}','{{ $product['price']}}', '{{ $product['product_feature_id']}}')">+</button>
                                                                                                </div>
                                                                                            </div>
                                                                                        </div>
                                                                                        <div class="cart_deletebox"
                                                                                                onclick="removeToSubCartCall('{{ $product['varient_id']}}', 'remove','','','','','','','{{ $product['product_name']}}','{{ $product['price']}}', '{{ $product['product_feature_id']}}')">                                                                                            
                                                                                                <img src="{{asset('assets/images/delete.svg')}}"
                                                                                                alt="Delete icon"
                                                                                                class="img-fluid">
                                                                                        </div>
                                                                    ...
                                                                    <div class="required_info_text cursor_pointer"
                                                                        ...
                                                                        <div class="" style="color: black;">
                                                                            Repeats on <strong
                                                                                style="color:green;">{{ $product['repeat_orders'] }}</strong>
                                                                            for <strong
                                                                                style="color: green;">{{ $product['sub_total_delivery'] }}</strong>
                                                                            weeks from <strong
                                                                                style="color:green;">{{ $product['sub_time_slot'] }}</strong>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    @else
                                                                    <div class="required_info_text cursor_pointer"
                                                                        data-product='@json($product)' style="color: black;"
                                                                        onclick="showWeekListUI('cart', this)">
                                                                        Repeats on <strong
                                                                            style="color:green;">{{ $product['repeat_orders'] }}</strong>
                                                                        for <strong
                                                                ...
                                                                <div class="check-date" id="checkDate">
                                                                    <div class="required_info_text"
                                                                        data-product-date="{{ $product['sub_delivery_date'] }}"
                                                                        data-product-datetime="{{ $product['sub_time_slot'] }}">
                                                                        <div class="required_info_text cursor_pointer"
                                                                            data-product='@json($product)'
                                                                            onclick="showWeekListUI('cart', this)">
                                                                        </div>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="car_order_detailsBox position__sticky1">
                                                        ...
                                                        <table>
                                                            <tbody>
                                                                <tr>
                                                                    ...
                                                                    <td id="totalPrice">
                                                                        <span>
                                                                            @if($subCartProductList['data']['total_price']!=
                                                                            $subCartProductList['data']['total_mrp'])
                                                                            <span class="regular-price">AED
                                                                                <span>{{number_format($subCartProductList['data']['total_mrp'], 2) }}</span>
                                                                            </span>
                                                                            @endif
                                                                        </span> AED
                                                                        {{number_format($subCartProductList['data']['total_price'], 2)}}
                                                                    </td>
                                                                </tr>
                                                                <tr class="small-text">
                                                                    <td>Delivery Charges</td>
                                                                    ...
                                                                    <td>
                                                                        <span
                                                                            ...
                                                                            <label for="subscription_wallet">AED
                                                                                <span
                                                                                    id="walletAmountS">{{ number_format($subCartProductList['data']['wallet_balance'], 2) }}</span>
                                                                            </label>
                                                                            <input type="checkbox"
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <strong id="totalPay">AED
                                                                            {{number_format($subCartProductList['data']['total_price'], 2)}}</strong>
                                                                    </td>
                                                                </tr>
                                                ...
                                                <div class="order_detailbox">
                                                       <div class="payment_address_box p-0 m-0">
                                                            @php //echo "<pre>";print_r($subCartProductList['data']);echo "</pre>"; @endphp
                                                            ...
                                                            <div class="address_detailsBox change_addressbox">
                                                                ...
                                                                <div class="address_details">
                                                                    <div class="address_head">
                                                                        ...
                                                                        <span class="address-type" id="addressType"
                                                                            style="font-weight: 600;">
                                                                            {{ $subCartProductList['data']['lastadd'][0]['type'] ?? ''}}
                                                                        </span>
                                                                    </div>
                                                                    <div class="address_location" id="showAddress">
                                                                        <p class="loaction">
                                                                            {{ $subCartProductList['data']['lastadd'][0]['house_no'] ?? ''}}
                                                                        </p>
                                                                    </div>
                                                                    <input type="hidden" id="addressId"
                                                                        name="address_id"
                                                                        value="{{ $subCartProductList['data']['lastadd'][0]['address_id'] ?? ''}}">
                                                                </div>
                                                            </div>
                                                            <div class="change_btn btn_addresslist"
                                                                style="font-weight: 600; color: green;"
                                                ...
                                                <div class="payment_mainBox new_payment_mainBox">
                                                    ...
                                                    @if(($subCartProductList['data']['isAutoRenew'] ?? '') === 'no')
                                                        ...
                                                        <div class="pay_btnbox subscription_cart_btn">
                                                            ...
                                                            <div class="show-card" id="cardNoSe">
                                                                <div class="payment_address_box payment_address_box_without_border">
                                                                 @if (!empty($subCartProductList['data']['lastcarddetails']))
                                                                    <div class="address_detailsBox">
                                                                        <div class="payment_add_img">
                                                                            <img src="{{asset('assets/images/pay_card.png')}}"
                                                                                alt="lock" style="max-width:35px">
                                                                        ...
                                                                        <div class="card_details">
                                                                            <div class="acard_details">
                                                                                Pay with card <span class="card-type"
                                                                                    id="cardType" style="font-weight: 600;">
                                                                                    {{ $subCartProductList['data']['lastcarddetails']['card_no'] ?? ''}}</span>
                                                                            </div>
                                                                            <input type="hidden" id="siNo" name="si_no"
                                                                                value="{{ $subCartProductList['data']['lastcarddetails']['si_sub_ref_no'] ?? ''}}">
                                                                        </div>
                                                                    </div>
                                                                 @endif
                                                                    <div class="change_btn"
                                                                        style="font-weight: 600; color: green;"
                                                                        data-bs-toggle="modal" data-bs-target="#cardModal"
                                                                        onclick="fetchCardList('{{ $subCartProductList['data']['lastcarddetails']['si_sub_ref_no'] ?? ''}}')">
                                                                        @if (!empty($subCartProductList['data']['lastcarddetails']))
                                                                            Change
                                                                        @else
                                                                            Add Card
                                                    ...
                                                    @else
                                                        ...
                                                        @endif
                                                    <input type="hidden" name="auto-renew" id="autoRenewID" value="{{ $subCartProductList['data']['isAutoRenew'] }}">    
                                                    <div class="pay_btn_wrap new_pay_btn_wrap">
                                                        <div class="trial_total_box">
                                                            <span class="total_heading">Total</span>
                                    ...
                                    <div class="owl-carousel owl-carousel-featured">
                                        ...
                                        <div class="item">
                                            <div class="product">
                                                ...
                                                <a href="{{ url('product-details') }}/{{ Str::slug($product['product_name']) }}/{{ trim($product['product_id']) }}">
                                                    <div class="product-img">
                                                        <img class="img-fluid" src="{{$product['varient_image']}}"
                                                            alt="product">
                                                    </div>
                                                    @if(isset($product['feature_tags']) &&
                                                    count($product['feature_tags']) > 0)
                                                ...
                                                <div class="product-footer">
                                                    ...
                                                    <div class="cart_btn">
                                                        <div class="sub_box">
                                                            <a class="subscribe_btn"
                                                                data-product='@json($product)'
                                                                onclick="removeToSubCartCall('{{ $product['varient_id']}}', 'add','{{ $product['cart_qty']}}','','','','','','{{ $product['product_name']}}','{{ $product['price']}}', '0')">
                                                                Add
                                                            </a>
                                                        </div>
                                                    </div>
        ...
        jQuery.ajax({
            ...
            success: function(result) {
                ...
                fbq('track', 'AddToCart', {
                    ...
                    localStorage.setItem("selectedTab", "2");
                   window.location.href = "{{ env('APP_URL') }}cart?tab=2";
                } else {
                    Swal.fire({
                    title: result.message,
                    icon: "error",
